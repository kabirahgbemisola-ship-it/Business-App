import { DollarSign, ArrowRight, Users, FileText, ShieldCheck } from "lucide-react"
    ...
    return(
        ...
        <div className="min-h-screen bg-slate-200 flex flex-col items-center
            ...
            <div className= "max-w-3xl animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className ="mx-auto bg-blue-100 text-blue-600 w-20 h-20 flex items-center 
                justify-center rounded-2xl mb-8 shadow-sm border-blue-200 ">
                    <DollarSign/>
                </div>
                <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 tracking-tight mb-6" >
                    Simplify your <span className="text-sky-600">2k Billing</span>
                </h1>
                <p className="text-lg md:text-xl text-slate-700 mb-10 max-w-2xl mx-auto">
                    ...
                    Fugit consequuntur ipsum aperiam quos reprehenderit quas fugiat voluptatibus facere.
                </p>

                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <button onClick={onNavigateLogin} className="flex items-center justify-center gap-2 bg-blue-600 
                        hover:bg-blue-700 text-white px-8 py-4 font-semibold 
                        rounded-xl text-lg transition-all shadow-lg hover:shadow-blue-600/25">
