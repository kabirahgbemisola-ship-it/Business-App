        ...
        <div className="bg-white p-6 rounded-xl border border-slate-50 shadow-sm h-full">
            ...
            {clients.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {clients.map(client => (
                        <div key={client.id} className="border border-slate-200 rounded-lg p-4 hover:border-blue-300 
                            ...
                            <button onClick={() => handleDelete(client.id)}
                                className="absolute top-4 right-4 text-slate-400 hover:text-red-500 opacity-0
